...
<form action='añadirchuche.php' method='post' enctype='multipart/form-data'>
  <fieldset>
    ...
    Categoria:<span name='cat'>".$id."</span><br><br>
...
<a href='chuches.php?idcat=$id'>Atras</a>
</fieldset>
</form>";
?>
<?php else:
     var_dump($id);
          ...
          if ($valid) {
              ...
              $consulta= "INSERT INTO chuches VALUES('NULL','1', '".$_POST['nam']."','".$_POST['desc']."','$target_file','".$_POST['precio']."')";
                ...
                echo "Error: " . $result . "<br>" . mysqli_error($connection);
          		...
          		header ("Location: chuches.php?idcat=".$id);
      	   }
        }
        ?>
